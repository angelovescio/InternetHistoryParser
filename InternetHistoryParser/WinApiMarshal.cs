...
namespace WinapiMarshal
{
    ...
    public class Functions
    {
        ...
        public static extern int NtDuplicateObject(IntPtr hProc, Int64 srcHandle, IntPtr destProc,out IntPtr destHandle, ulong accessMask, OBJECT_ATTRIBUTES attributes, ulong options);
        ...
        internal static extern int CreateVssBackupComponentsXp(
            out IVssBackupComponentsXp vssBackupCmpnts
            );
        [DllImport("vssapi.dll", EntryPoint = "?CreateVssBackupComponents@@YGJPAPAVIVssBackupComponents@@@Z")]
        internal static extern int CreateVssBackupComponentsXp2(
            [Out,MarshalAs(UnmanagedType.IUnknown)] out object vssBackupCmpnts
            );
        ...
        public VssSnapshotProperties GetSnapshotProperties(IVssBackupComponents backupComponents, Guid snapshotId)
        {
            ...
            VssFreeSnapshotProperties(buffer);
            return props;
        }
        #endregion
    ...
    public interface IVssBackupComponents
    {
        ...
        int GatherWriterMetadata(out IVssAsync async);
        ...
        int PrepareForBackup(out IVssAsync async);
        ...
        int DoSnapshotSet(out IVssAsync async);
    ...
    public interface IVssBackupComponentsXp2
    {
	...
	void GetWriterComponents
		(
		uint iWriter, out IntPtr ppWriter
		);
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    [Guid("00000000-0000-0000-C000-000000000046")]
    public interface IVssBackupComponentsXp
    {
        void GetWriterComponentsCount(out uint pcComponents);
    ...
    internal static class Win32Errors
    {
        public static int GetHRFromWin32Error(uint errorCode)
        {
            unchecked
            {
                ...
                return (int)((errorCode & 0x0000FFFF) | 0x80070000);
            }
        }
