...
*/
//TEST
static List<string> GetSqlTableResults = new List<string>();
//TEST
    
static public int sqlite3_get_table_cb(ref object pArg, i64 nCol, object Oargv, object Ocolv)
{
    ...
    */
    ...
    if (p.nData + need >= p.nAlloc)
    {
        ...
        for (int j = 0; j < azNew.Length; j++)
        {
            p.azResult.Add(azNew[j]);
        }
    }
...
)
{
    ...
    res.nAlloc = 20;
    res.rc = SQLITE_OK;
    res.azResult = new List<string>();// sqlite3_malloc( sizeof( char* ) * res.nAlloc );
    ...
    pazResult = res.azResult.ToArray();
